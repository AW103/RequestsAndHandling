...
sayHelloButton.addEventListener("mouseover", newColor);
...
sayHelloButton.addEventListener("mouseout", oldColor);
...
const queryTest = () => {
    axios.get('http://localhost:3000/query-test/?color=red&name=clifford').then(res => {
        console.log(res.data);
    })
}
